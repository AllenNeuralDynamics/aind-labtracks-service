...
class Task(BaseModel):
    ...
    investigator_id: Optional[Annotated[str, Field(strict=True)]] = None
    task_description: Optional[StrictStr] = None
    task_object: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    def investigator_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('task_object')
    def task_object_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
