...
class DefaultApi:
    ...
    @validate_call
    async def get_subject_by_protocol_number(
        self,
        protocol_number: StrictStr,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param protocol_number: (required)
        :type protocol_number: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_subject_by_protocol_number_serialize(
    ...
    @validate_call
    async def get_subject_by_protocol_number_with_http_info(
        self,
        protocol_number: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_subject_by_protocol_number_without_preload_content(
        self,
        protocol_number: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_subject_by_protocol_number_serialize(
        self,
        protocol_number,
        _request_auth,
        _content_type,
        ...
        if protocol_number is not None:
            _path_params['protocol_number'] = protocol_number
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subject_by_protocol_number/{protocol_number}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
