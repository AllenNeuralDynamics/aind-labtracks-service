...
*DefaultApi* | [**get_subject_by_protocol_number**](docs/DefaultApi.md#get_subject_by_protocol_number) | **GET** /subject_by_protocol_number/{protocol_number} | Get Subject By Protocol Number
