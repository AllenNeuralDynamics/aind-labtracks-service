...
class Subject(BaseModel):
    ...
    cage_id: Optional[Annotated[str, Field(strict=True)]] = None
    room_id: Optional[Annotated[str, Field(strict=True)]] = None
    paternal_id: Optional[Annotated[str, Field(strict=True)]] = None
    paternal_class_values: Optional[MouseCustomClass] = None
    maternal_id: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "class_values", "sex", "birth_date", "death_date", "species_name", "cage_id", "room_id", "paternal_id", "paternal_class_values", "maternal_id", "maternal_class_values", "group_name", "group_description", "protocol_number", "protocol_title"]
    ...
    def cage_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def room_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('paternal_id')
    def paternal_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('maternal_id')
    def maternal_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
